...
public class AnnotationScannerBootJarIntegrationTest {
    ...
    public void testBootStyleJarRunsScannerInForkedProcess() throws Exception {
        ...
        String runnerSource = "package " + runnerPkg + ";\n" +
                ...
                "      java.lang.reflect.Method m = com.thegoate.annotations.AnnotationScanner.class.getDeclaredMethod(\"scanJarFile\", java.io.File.class);\n" +
                "      m.setAccessible(true);\n" +
                "      @SuppressWarnings(\"unchecked\")\n" +
                "      java.util.List<String> pkgs = (java.util.List<String>) m.invoke(null, jar);\n" +
        ...
        try (InputStream ais = AnnotationScanner.class.getResourceAsStream("/com/thegoate/annotations/AnnotationScanner.class");
             ByteArrayOutputStream bos = new ByteArrayOutputStream()) {
            if (ais == null) {
            ...
            scannerClassBytes = bos.toByteArray();
        }
        ...
        try (FileOutputStream fos = new FileOutputStream(outerJar);
            ...
            JarEntry scannerEntry = new JarEntry("com/thegoate/annotations/AnnotationScanner.class");
            jos.putNextEntry(scannerEntry);
            jos.write(scannerClassBytes);
            jos.closeEntry();
        ...
        Assert.assertTrue(output.contains("com.outer"), "Output should contain outer package 'com.outer'. Output:\n" + output);
    }
}
